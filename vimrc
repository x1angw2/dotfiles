...
" 	File template
" ---------------------------
if filereadable("/Users/wezhon/.vim/template/python")
	autocmd BufNewFile *.py 0 read /Users/wezhon/.vim/template/python
endif
...
"-------coc.vim------------
let g:coc_global_extensions = ['coc-jedi','coc-python','coc-json','coc-vimlsp','coc-marketplace','coc-html']
